...
export interface NetworkConfig {
  ...
  chainId: number;
  /** Symbol for the native currency (e.g., 'ETH', 'MATIC') */
  nativeSymbol: string;
  /** Human-readable name for the native currency */
  nativeName: string;
  /** Base URL for the block explorer (e.g., 'https://etherscan.io') */
  blockExplorer?: string;
  /** API endpoint for the block explorer (Etherscan-compatible) */
